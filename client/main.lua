...
AddEventHandler('esx:playerLoaded', function(xPlayer)
    ...
    local moneyTpl = '<div><img src="https://zupimages.net/up/19/32/uk9s.png"/> {{money}}</div>'
	...
	if Config.EnableHud then
		...
		local jobTpl = '<div><img src="https://zupimages.net/up/19/32/vls4.png"/> {{job_label}} - {{grade_label}}</div>'
